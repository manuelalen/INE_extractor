...
url = "https://servicios.ine.es/wstempus/jsCache/ES/DATOS_TABLA/69069"
...
df.to_sql('ine_agregados_economicos', con=engine, if_exists='replace', index=False)

print("🤙 Datos insertados correctamente en la tabla 'ine_agregados_economicos'")
